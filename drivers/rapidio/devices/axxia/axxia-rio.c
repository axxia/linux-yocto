 ...
 */
static int
rio_parse_dtb(struct platform_device *dev, int *ndx, u64 *law_start,
	      u64 *law_size, struct resource *regs, int *ob_num_dmes,
	      int *outb_dmes, int *ib_num_dmes,	int *inb_dmes, int *irq,
