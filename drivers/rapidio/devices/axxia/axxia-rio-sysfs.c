...
static DEVICE_ATTR(stat, 0444, stat_show, NULL);
...
static DEVICE_ATTR(misc_stat, 0444, misc_stat_show, NULL);
...
static DEVICE_ATTR(ib_dme_stat, 0444, ib_dme_stat_show, NULL);
...
static DEVICE_ATTR(ob_dme_stat, 0444, ob_dme_stat_show, NULL);
...
static DEVICE_ATTR(irq, 0444, irq_show, NULL);
...
static DEVICE_ATTR(tmo, 0444, tmo_show, NULL);
...
static DEVICE_ATTR(dme_log, 0444, dme_log_show, NULL);
